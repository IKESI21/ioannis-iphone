...
const NavIcons = (): JSX.Element => {
  return (
    <div className="flex justify-evenly self-center place-content-center w-screen bg-opacity-20 rounded-sm bg-gray-600 pt-3 absolute bottom-0 left-0 right-0">
      <CustomApp
        title="Messages"
